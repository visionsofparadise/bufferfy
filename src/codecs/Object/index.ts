...
export const createObjectCodec = <Properties extends Record<string | number, AbstractCodec<any>>>(...parameters: ConstructorParameters<typeof ObjectCodec<Properties>>) => {
